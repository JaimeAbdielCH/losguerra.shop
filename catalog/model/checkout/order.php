	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'payment_geo_zone_id'     => $order_query->row['payment_geo_zone_id'],
				'payment_ltnlng'          => $order_query->row['payment_ltnlng'],
				...
				'shipping_geo_zone_id'    => $order_query->row['shipping_geo_zone_id'],
				'shipping_ltnlng'         => $order_query->row['shipping_ltnlng'],
