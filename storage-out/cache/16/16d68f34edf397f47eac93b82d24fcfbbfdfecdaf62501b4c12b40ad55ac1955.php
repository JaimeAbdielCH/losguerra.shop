...
class __TwigTemplate_5ec2a08cc724d3c17c30087b55889355bd6187e902657475c85630c682b281d2 extends Twig_Template
{
  ...
  <form action=\"";
    ...
    <div class=\"btn-group\" style=\"padding-top: 3px;\">
      <button class=\"btn-link dropdown-toggle\" data-toggle=\"dropdown\">";
            ...
            echo " <span class=\"font20 hidden-xs hidden-sm hidden-md\">";
...
/*     <div class="btn-group" style="padding-top: 3px;">*/
/*       <button class="btn-link dropdown-toggle" data-toggle="dropdown">{% for currency in currencies %}*/
/*       {% if currency.symbol_left and currency.code == code %} <strong class="font20">{{ currency.symbol_left }}</strong> {% elseif currency.symbol_right and currency.code == code %} <strong>{{ currency.symbol_right }}</strong> {% endif %}*/
/*       {% endfor %} <span class="font20 hidden-xs hidden-sm hidden-md">{{ text_currency }}</span>&nbsp;<i class="fa fa-caret-down"></i></button>*/
/*       <ul class="dropdown-menu">*/
