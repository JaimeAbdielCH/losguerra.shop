...
(1, 1, 'admin', '$2y$10$4IaGWKTqheyFGhGltOyibuFmckhjnOmZW8tCg23961DNHIxpOPbeW', 'John', 'Doe', 'jaime.abdiel@gmail.com', '', '', '172.23.0.1', 1, '2023-01-24 21:44:58');
...
(1, 1, '172.23.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36 Edg/109.0.1518.61', '2023-01-24 21:52:12');
...
--
ALTER TABLE `oc_subscription_status`
  MODIFY `subscription_status_id` int(11) NOT NULL AUTO_INCREMENT;
